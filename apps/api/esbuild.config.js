...
await esbuild.build({
  entryPoints: {
    ...
    'workspace-create': './src/handlers/workspace-create.handler.ts',
    'workspace-list': './src/handlers/workspace-list.handler.ts',
    'workspace-get': './src/handlers/workspace-get.handler.ts',
    'workspace-update': './src/handlers/workspace-update.handler.ts',
    'workspace-delete': './src/handlers/workspace-delete.handler.ts',
  },
  bundle: true,
  platform: 'node',
  target: 'node20',
